function build_upper_specialization(variant,u){
 ...
 const chest=[ex('Band Chest Fly',['bands'],'3 × 12–20',3,'Chest','Chest isolation','fly'),ex('Dumbbell Fly',['dumbbells','bench'],'3 × 10–15',3,'Chest','Chest isolation','fly'),ex('Wide Push-Up',[],'3 × 10–20',3,'Chest','Chest isolation','fly')];
 ...
 return [slot(u,press),slot(u,row),slot(u,chest),slot(u,vertical),slot(u,lateral),slot(u,arms)];
